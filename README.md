# Cybersecurity - TLS Interception using ARP spoofing

Overview of the file structure:
- Main report is found as `report.pdf` in `root`.<br>
- The used caplet is found in `assets/arp_spoofing.cap`.<br>
- The presentation is found in `assets/presentation.pdf`.<br>
